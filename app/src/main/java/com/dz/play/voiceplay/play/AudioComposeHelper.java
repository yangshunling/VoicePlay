...
public class AudioComposeHelper {
    ...
    public AudioComposeHelper(Context paramContext, String paramString) {
        ...
        mMatchMap.put("十", "tts_shi.mp3");
        mMatchMap.put("百", "tts_bai.mp3");
        mMatchMap.put("千", "tts_qian.mp3");
        mMatchMap.put("万", "tts_wan.mp3");
        mMatchMap.put("亿", "tts_yi.mp3");
